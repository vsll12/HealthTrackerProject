    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className="flex h-screen bg-gray-100 text-gray-900">
          {/* Friends Sidebar - Changed from black to white */}
          <div className="w-80 bg-white border-r border-gray-200 p-4 overflow-y-auto md:block hidden">
              ...
              <ul className="space-y-2">
                {friends.map((friend) => (
                  <li
                    ...
                    className={`p-3 cursor-pointer flex items-center rounded-md hover:bg-gray-100 transition ${
                  ...
                  >
                    ...
                    <span className="ml-4 text-sm text-gray-800">{friend.name}</span>
                  </li>
                ))}
              </ul>
            ) : (
          ...
          <div className="flex-1 flex flex-col">
            ...
            {selectedFriend ? (
              <>
                        ...
                        {editingMessageId === msg.id ? (
                          <div>
                            <input
                              ...
                              className="w-full p-2 rounded-md border bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
                            />
                ...
                <div className="p-4 flex items-center bg-white shadow-inner">
                  <input
                    type="text"
                    value={message}
                    onChange={(e) => {
                    ...
                    className="flex-1 p-3 rounded-full border bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
                    onKeyPress={(e) => {
