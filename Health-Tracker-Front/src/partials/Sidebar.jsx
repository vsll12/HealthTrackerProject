            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname === "/" || pathname.includes("dashboard")}>
                {(handleClick, open) => {
                  ...
                  {/* Meals-calorie-calculator */}
              <li
                className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("calculator")}`}
              >
                    <NavLink
                      end
                      to={`/meals-calculator`}
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <svg
                          ...
                          viewBox="0 0 24 24"
                        >
                          <path d="M8 2a1 1 0 0 1 1 1v7.586l2.293-2.293a1 1 0 0 1 1.414 1.414L10 13.414V21a1 1 0 1 1-2 0v-7.586l-2.293 2.293a1 1 0 1 1-1.414-1.414L8 10.586V3a1 1 0 0 1 1-1Zm8.707 4.707a1 1 0 0 0-1.414-1.414L14 6.586 11.707 4.293a1 1 0 0 0-1.414 1.414L12.586 8l-2.293 2.293a1 1 0 0 0 1.414 1.414L14 9.414l2.293 2.293a1 1 0 0 0 1.414-1.414L15.414 8l2.293-2.293Z" />
                        </svg>
                          <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                            Meals Calculator
                          </span>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <svg
                          ...
                          viewBox="0 0 24 24"
                        >
                          <path d="M12 1a11 11 0 1 0 11 11A11.013 11.013 0 0 0 12 1Zm0 20a9 9 0 1 1 9-9 9.01 9.01 0 0 1-9 9Zm0-16a7 7 0 1 0 7 7 7.008 7.008 0 0 0-7-7Zm0 12a5 5 0 1 1 5-5 5.006 5.006 0 0 1-5 5Zm0-8a3 3 0 1 0 3 3 3 3 0 0 0-3-3Z" />
                        </svg>
                          <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                            Goals
                          </span>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <svg
                          ...
                          viewBox="0 0 24 24"
                        >
                          <path d="M13.879 2.879a3 3 0 0 0-4.242 0L5.636 6.879A8 8 0 1 0 20 13a8 8 0 0 0-2.343-5.657l-3.778-3.464ZM12 22a7 7 0 1 1 4.95-11.95l-4.121-3.778a1 1 0 0 1 1.342-1.478l4.12 3.778A7 7 0 0 1 12 22Z" />
                        </svg>
                          <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                            Calorie Calculator
                          </span>
